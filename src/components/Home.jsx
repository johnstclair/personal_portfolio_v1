      ...
      <Notif />
			...
			<div className="about-me section" ref={aboutMe} id="aboutMe">
				...
				<p>
					...
					<br /> <br />
					{
						"I'm John St. Clair, a student who enjoys computers and learning new things. In the past I have worked with languages such as Javascript, Python, C, C# and Java. I have used tools such as Godot, Nix - as well as general Linux, Git with Github and the MERN stack. I have experience with soldering and playing with microcontrollers, mainly Arduino’s and Raspberry Pi’s."
					}
				</p>
			</div>
